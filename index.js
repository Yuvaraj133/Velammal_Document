...
app.get('/Conferenceadmin',isAuthenticated, async (req, res) => {
...
app.get('/articleadmin',isAuthenticated, async (req, res) => {
...
app.get('/booksadmin', isAuthenticated,async (req, res) => {
...
app.get('/projectadmin', isAuthenticated,async (req, res) => {
...
app.get('/conferencestore',isAuthenticated, (req, res) => {
  res.sendFile(__dirname + '/ConfernceStore.html');
});
app.get('/articlestore',isAuthenticated, (req, res) => {
  res.sendFile(__dirname + '/article.html');
});
app.get('/booksstore',isAuthenticated, (req, res) => {
  res.sendFile(__dirname + '/books.html');
});
app.get('/projectstore', isAuthenticated,(req, res) => {
...
app.get('/patentsubmit',isAuthenticated, (req, res) => {
  res.sendFile(__dirname + '/submit.html');
});

app.post('/patentsubmit',isAuthenticated,upload.single('patentFile') ,async (req, res) => {
  if (!req.file) {
...
app.get('/bookssubmit', isAuthenticated,(req, res) => {
  res.sendFile(__dirname + '/submit.html');
});

app.post('/bookssubmit',isAuthenticated,upload.single('patentFile') ,async (req, res) => {
...
app.get('/articlesubmit',isAuthenticated, (req, res) => {
  res.sendFile(__dirname + '/submit.html');
});

app.post('/articlesubmit',isAuthenticated,async (req, res) => {
...
app.post('/submit',isAuthenticated,upload.single('patentFile') ,async (req, res) => {
...
app.get('/projectsubmit',isAuthenticated, (req, res) => {
  res.sendFile(__dirname + '/submit.html');
});
...
app.get('/projecttable', isAuthenticated,async (req, res) => {
  try {
    const totalCount = await project.countDocuments({});
    let j=1;
    const items = await project.find();
